...
category: article
title: 金曜日のエンジニアのつどい - 2023/02/17 週
explain: StyleLint v15 リリース、Laravel 10 リリース、Nx 17 リリース、Riverpod_lint リリース、dio のメンテナンス終了、Developers Summit 2023
type: post
date: 2023-02-17
tags:
  - Review
...
なお、はてなホットエントリーに入る登壇資料だけでも、下に示す通り知見は少なくありません。
